#!/usr/bin/env bash
# verify_nic_selection.sh  (docker-2node-ll-v2)
#
...
WRAPPER_PATH="$DEEP_EP_DIR/tests/docker-2node-ll-v2/node_wrapper.sh"
CHECK_DIR="$DEEP_EP_DIR/tests/docker-2node-ll-v2"
