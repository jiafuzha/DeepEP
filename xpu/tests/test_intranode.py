...
def test_loop(local_rank: int, num_local_ranks: int, args: argparse.Namespace):
    ...
    for i in (24, ):
        test_main(args, i, local_rank, num_ranks, rank, buffer, group, skip_benchmark=args.smoke_only)
        if local_rank == 0:
            print('', flush=True)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Test experimental XPU intranode EP kernels')
